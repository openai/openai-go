...
type CodeInterpreterToolCallCodeInterpreter struct {
	...
	Outputs []CodeInterpreterToolCallCodeInterpreterOutputsUnion `json:"outputs,required"`
	// Metadata and presence of fields
	JSON struct {
		Input       resp.Field
		Outputs     resp.Field
...
// CodeInterpreterToolCallCodeInterpreterOutputsUnion contains all possible
// properties and values from [CodeInterpreterToolCallCodeInterpreterOutputsLogs,
// CodeInterpreterToolCallCodeInterpreterOutputsImage].
//
// Use CodeInterpreterToolCallCodeInterpreterOutputsUnion.AsAny() to switch on the
// variant.
//
...
//
//	switch variant := CodeInterpreterToolCallCodeInterpreterOutputsUnion.AsAny().(type) {
//	case CodeInterpreterToolCallCodeInterpreterOutputsLogs:
//	case CodeInterpreterToolCallCodeInterpreterOutputsImage:
//	default:
//	  fmt.Errorf("no variant present")
//	}
func (u CodeInterpreterToolCallCodeInterpreterOutputsUnion) AsAny() any {
	switch u.Type {
	case "logs":
		return u.AsLogs()
	case "image":
...
type CodeInterpreterToolCallDeltaCodeInterpreter struct {
	...
	// or more items, including text (`logs`) or images (`image`). Each of these are
	// represented by a different object type.
	Outputs []CodeInterpreterToolCallDeltaCodeInterpreterOutputsUnion `json:"outputs"`
	// Metadata and presence of fields
	JSON struct {
		Input       resp.Field
		Outputs     resp.Field
...
// CodeInterpreterToolCallDeltaCodeInterpreterOutputsUnion contains all possible
// properties and values from [CodeInterpreterLogs, CodeInterpreterOutputImage].
//
// Use CodeInterpreterToolCallDeltaCodeInterpreterOutputsUnion.AsAny() to switch on
// the variant.
//
// Use the methods beginning with 'As' to cast the union to one of its variants.
...
// Use the following switch statement to find the correct variant
//
//	switch variant := CodeInterpreterToolCallDeltaCodeInterpreterOutputsUnion.AsAny().(type) {
//	case CodeInterpreterLogs:
//	case CodeInterpreterOutputImage:
//	default:
//	  fmt.Errorf("no variant present")
//	}
func (u CodeInterpreterToolCallDeltaCodeInterpreterOutputsUnion) AsAny() any {
	switch u.Type {
	case "logs":
		return u.AsLogs()
	case "image":
...
//
// Use RunStepStepDetailsUnion.AsAny() to switch on the variant.
//
// Use the methods beginning with 'As' to cast the union to one of its variants.
...
//
// Use RunStepDeltaStepDetailsUnion.AsAny() to switch on the variant.
//
// Use the methods beginning with 'As' to cast the union to one of its variants.
...
//
// Use ToolCallUnion.AsAny() to switch on the variant.
//
// Use the methods beginning with 'As' to cast the union to one of its variants.
...
// [CodeInterpreterToolCallDelta, FileSearchToolCallDelta, FunctionToolCallDelta].
//
// Use ToolCallDeltaUnion.AsAny() to switch on the variant.
//
// Use the methods beginning with 'As' to cast the union to one of its variants.
