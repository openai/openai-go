...
func TestIsGeneratedServiceSource(t *testing.T) {
	tests := []struct {
		...
		{
			name:   "service generated by another tool",
			path:   "service.go",
			source: "// File generated from our OpenAPI spec by another tool.",
			want:   false,
		},
		{
...
func isGeneratedServiceSource(path string, source []byte) bool {
	...
	return strings.HasPrefix(string(source), "// File generated from our OpenAPI spec by Castiron.")
}
