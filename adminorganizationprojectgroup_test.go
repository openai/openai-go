...
func TestAdminOrganizationProjectGroupGetWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.Admin.Organization.Projects.Groups.Get(
		...
		openai.AdminOrganizationProjectGroupGetParams{
			GroupType: openai.AdminOrganizationProjectGroupGetParamsGroupTypeGroup,
		},
	)
	if err != nil {
		var apierr *openai.Error
...
func TestAdminOrganizationProjectGroupListWithOptionalParams(t *testing.T) {
	...
	_, err := client.Admin.Organization.Projects.Groups.List(
		...
		openai.AdminOrganizationProjectGroupListParams{
			...
			Limit: openai.Int(0),
			Order: openai.AdminOrganizationProjectGroupListParamsOrderAsc,
		},
	)
	if err != nil {
		var apierr *openai.Error
