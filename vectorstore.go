...
//
// Use FileChunkingStrategyUnion.AsAny() to switch on the variant.
//
...
type VectorStoreSearchResponse struct {
	...
	Attributes map[string]VectorStoreSearchResponseAttributesUnion `json:"attributes,required"`
...
// VectorStoreSearchResponseAttributesUnion contains all possible properties and
...
type VectorStoreSearchResponseAttributesUnion struct {
...
func (u VectorStoreSearchResponseAttributesUnion) AsString() (v string) {
	apijson.UnmarshalRoot(json.RawMessage(u.JSON.raw), &v)
	return
}

func (u VectorStoreSearchResponseAttributesUnion) AsFloat() (v float64) {
	apijson.UnmarshalRoot(json.RawMessage(u.JSON.raw), &v)
	return
}

func (u VectorStoreSearchResponseAttributesUnion) AsBool() (v bool) {
	apijson.UnmarshalRoot(json.RawMessage(u.JSON.raw), &v)
	return
}

// Returns the unmodified JSON received from the API
func (u VectorStoreSearchResponseAttributesUnion) RawJSON() string { return u.JSON.raw }

func (r *VectorStoreSearchResponseAttributesUnion) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
type VectorStoreListParams struct {
	...
	//
	// Any of "asc", "desc".
	Order VectorStoreListParamsOrder `query:"order,omitzero"`
	paramObj
}
...
type VectorStoreSearchParamsQueryUnion struct {
	...
	OfVectorStoreSearchsQueryArray []string
	paramUnion
}
