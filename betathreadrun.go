...
// IsPresent returns false if the field is omitted or `null`.
func (u BetaThreadRunNewParamsAdditionalMessagesContentUnion) IsPresent() bool {
...
// IsPresent returns false if the field is omitted or `null`.
func (f BetaThreadRunNewParamsAdditionalMessagesAttachment) IsPresent() bool {
	return !param.IsOmitted(f) && !f.IsNull()
}
...
// IsPresent returns false if the field is omitted or `null`.
func (u BetaThreadRunNewParamsAdditionalMessagesAttachmentsToolUnion) IsPresent() bool {
	return !param.IsOmitted(u) && !u.IsNull()
}
...
// IsPresent returns false if the field is omitted or `null`.
func (f BetaThreadRunNewParamsAdditionalMessagesAttachmentsToolsFileSearch) IsPresent() bool {
	return !param.IsOmitted(f) && !f.IsNull()
}
