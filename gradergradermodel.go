...
type LabelModelGrader struct {
	Input []shared.EvalItem `json:"input,required"`
...
type LabelModelGraderParam struct {
	Input []shared.EvalItemParam `json:"input,omitzero,required"`
	// The labels to assign to each item in the evaluation.
...
// will be valid: OfString OfLabelModelGraderInput]
type MultiGraderGraderUnionInput struct {
	...
	// object.
	OfLabelModelGraderInput []shared.EvalItem `json:",inline"`
	JSON                    struct {
