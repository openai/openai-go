...
func TestJSONRoute(t *testing.T) {
	chatCompletionParams := openai.ChatCompletionNewParams{
		...
		Messages: []openai.ChatCompletionMessageParamUnion{
			openai.ChatCompletionMessageParamOfAssistant("You are a helpful assistant"),
			openai.ChatCompletionMessageParamOfUser("Can you tell me another word for the universe?"),
		},
	}
