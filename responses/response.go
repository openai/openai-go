...
func (u ResponseOutputTextAnnotationUnionParam) MarshalJSON() ([]byte, error) {
	return param.MarshalUnion(u, u.OfFileCitation, u.OfURLCitation, u.OfFilePath)
}
...
type ResponseStreamEventUnion struct {
	...
	// [ResponseStreamEventResponseOutputTextAnnotationAdded].
	Annotation ResponseStreamEventResponseOutputTextAnnotationAddedAnnotationUnion `json:"annotation"`
	// This field is from variant
	// [ResponseStreamEventResponseOutputTextAnnotationAdded].
...
func (ResponseStreamEventResponseOutputTextAnnotationAdded) implResponseStreamEventUnion() {}
...
//	case responses.ResponseStreamEventResponseOutputTextAnnotationAdded:
...
func (u ResponseStreamEventUnion) AsResponseOutputTextAnnotationAdded() (v ResponseStreamEventResponseOutputTextAnnotationAdded) {
	apijson.UnmarshalRoot(json.RawMessage(u.JSON.raw), &v)
	return
}
...
type ResponseStreamEventResponseOutputTextAnnotationAdded struct {
	// A citation to a file.
	Annotation ResponseStreamEventResponseOutputTextAnnotationAddedAnnotationUnion `json:"annotation,required"`
...
// Returns the unmodified JSON received from the API
func (r ResponseStreamEventResponseOutputTextAnnotationAdded) RawJSON() string { return r.JSON.raw }
func (r *ResponseStreamEventResponseOutputTextAnnotationAdded) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// ResponseStreamEventResponseOutputTextAnnotationAddedAnnotationUnion contains all
// possible properties and values from
// [ResponseStreamEventResponseOutputTextAnnotationAddedAnnotationFileCitation],
// [ResponseStreamEventResponseOutputTextAnnotationAddedAnnotationURLCitation],
// [ResponseStreamEventResponseOutputTextAnnotationAddedAnnotationFilePath].
//
// Use the
// [ResponseStreamEventResponseOutputTextAnnotationAddedAnnotationUnion.AsAny]
// method to switch on the variant.
//
// Use the methods beginning with 'As' to cast the union to one of its variants.
type ResponseStreamEventResponseOutputTextAnnotationAddedAnnotationUnion struct {
	FileID string `json:"file_id"`
	Index  int64  `json:"index"`
	// Any of "file_citation", "url_citation", "file_path".
	Type string `json:"type"`
...
// anyResponseStreamEventResponseOutputTextAnnotationAddedAnnotation is implemented
// by each variant of
// [ResponseStreamEventResponseOutputTextAnnotationAddedAnnotationUnion] to add
// type safety for the return type of
// [ResponseStreamEventResponseOutputTextAnnotationAddedAnnotationUnion.AsAny]
type anyResponseStreamEventResponseOutputTextAnnotationAddedAnnotation interface {
	implResponseStreamEventResponseOutputTextAnnotationAddedAnnotationUnion()
}

func (ResponseStreamEventResponseOutputTextAnnotationAddedAnnotationFileCitation) implResponseStreamEventResponseOutputTextAnnotationAddedAnnotationUnion() {
}
func (ResponseStreamEventResponseOutputTextAnnotationAddedAnnotationURLCitation) implResponseStreamEventResponseOutputTextAnnotationAddedAnnotationUnion() {
}
func (ResponseStreamEventResponseOutputTextAnnotationAddedAnnotationFilePath) implResponseStreamEventResponseOutputTextAnnotationAddedAnnotationUnion() {
}

// Use the following switch statement to find the correct variant
//
//	switch variant := ResponseStreamEventResponseOutputTextAnnotationAddedAnnotationUnion.AsAny().(type) {
//	case responses.ResponseStreamEventResponseOutputTextAnnotationAddedAnnotationFileCitation:
//	case responses.ResponseStreamEventResponseOutputTextAnnotationAddedAnnotationURLCitation:
//	case responses.ResponseStreamEventResponseOutputTextAnnotationAddedAnnotationFilePath:
//	default:
//	  fmt.Errorf("no variant present")
//	}
func (u ResponseStreamEventResponseOutputTextAnnotationAddedAnnotationUnion) AsAny() anyResponseStreamEventResponseOutputTextAnnotationAddedAnnotation {
	switch u.Type {
	case "file_citation":
		return u.AsFileCitation()
	case "url_citation":
...
func (u ResponseStreamEventResponseOutputTextAnnotationAddedAnnotationUnion) AsFileCitation() (v ResponseStreamEventResponseOutputTextAnnotationAddedAnnotationFileCitation) {
	apijson.UnmarshalRoot(json.RawMessage(u.JSON.raw), &v)
	return
}

func (u ResponseStreamEventResponseOutputTextAnnotationAddedAnnotationUnion) AsURLCitation() (v ResponseStreamEventResponseOutputTextAnnotationAddedAnnotationURLCitation) {
	apijson.UnmarshalRoot(json.RawMessage(u.JSON.raw), &v)
	return
}

func (u ResponseStreamEventResponseOutputTextAnnotationAddedAnnotationUnion) AsFilePath() (v ResponseStreamEventResponseOutputTextAnnotationAddedAnnotationFilePath) {
	apijson.UnmarshalRoot(json.RawMessage(u.JSON.raw), &v)
	return
}

// Returns the unmodified JSON received from the API
func (u ResponseStreamEventResponseOutputTextAnnotationAddedAnnotationUnion) RawJSON() string {
	return u.JSON.raw
}

func (r *ResponseStreamEventResponseOutputTextAnnotationAddedAnnotationUnion) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// A citation to a file.
type ResponseStreamEventResponseOutputTextAnnotationAddedAnnotationFileCitation struct {
	// The ID of the file.
	FileID string `json:"file_id,required"`
	// The index of the file in the list of files.
	Index int64 `json:"index,required"`
...
// Returns the unmodified JSON received from the API
func (r ResponseStreamEventResponseOutputTextAnnotationAddedAnnotationFileCitation) RawJSON() string {
	return r.JSON.raw
}
func (r *ResponseStreamEventResponseOutputTextAnnotationAddedAnnotationFileCitation) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// A citation for a web resource used to generate a model response.
type ResponseStreamEventResponseOutputTextAnnotationAddedAnnotationURLCitation struct {
	// The index of the last character of the URL citation in the message.
	EndIndex int64 `json:"end_index,required"`
	// The index of the first character of the URL citation in the message.
	StartIndex int64 `json:"start_index,required"`
...
// Returns the unmodified JSON received from the API
func (r ResponseStreamEventResponseOutputTextAnnotationAddedAnnotationURLCitation) RawJSON() string {
	return r.JSON.raw
}
func (r *ResponseStreamEventResponseOutputTextAnnotationAddedAnnotationURLCitation) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// A path to a file.
type ResponseStreamEventResponseOutputTextAnnotationAddedAnnotationFilePath struct {
	// The ID of the file.
	FileID string `json:"file_id,required"`
	// The index of the file in the list of files.
	Index int64 `json:"index,required"`
...
// Returns the unmodified JSON received from the API
func (r ResponseStreamEventResponseOutputTextAnnotationAddedAnnotationFilePath) RawJSON() string {
	return r.JSON.raw
}
func (r *ResponseStreamEventResponseOutputTextAnnotationAddedAnnotationFilePath) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
func (u ToolUnionParam) MarshalJSON() ([]byte, error) {
	return param.MarshalUnion(u, u.OfFileSearch, u.OfFunction, u.OfWebSearchPreview, u.OfComputerUsePreview)
}
