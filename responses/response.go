...
type Response struct {
	...
	// available models.
	Model shared.ChatModel `json:"model,required"`
...
type ResponseCodeInterpreterToolCall struct {
	...
	Results []ResponseCodeInterpreterToolCallResultsUnion `json:"results,required"`
...
// ResponseCodeInterpreterToolCallResultsUnion contains all possible properties and
// values from [ResponseCodeInterpreterToolCallResultsLogs,
// ResponseCodeInterpreterToolCallResultsFiles].
//
// Use ResponseCodeInterpreterToolCallResultsUnion.AsAny() to switch on the
// variant.
//
// Use the methods beginning with 'As' to cast the union to one of its variants.
type ResponseCodeInterpreterToolCallResultsUnion struct {
	Logs string `json:"logs"`
	// Any of "logs", "files".
	Type  string                                            `json:"type"`
	Files []ResponseCodeInterpreterToolCallResultsFilesFile `json:"files"`
	JSON  struct {
		Logs  resp.Field
		Type  resp.Field
		Files resp.Field
...
//
//	switch variant := ResponseCodeInterpreterToolCallResultsUnion.AsAny().(type) {
//	case ResponseCodeInterpreterToolCallResultsLogs:
//	case ResponseCodeInterpreterToolCallResultsFiles:
//	default:
//	  fmt.Errorf("no variant present")
//	}
func (u ResponseCodeInterpreterToolCallResultsUnion) AsAny() any {
	switch u.Type {
	case "logs":
		return u.AsLogs()
	case "files":
...
func (u ResponseCodeInterpreterToolCallResultsUnion) AsLogs() (v ResponseCodeInterpreterToolCallResultsLogs) {
	apijson.UnmarshalRoot(json.RawMessage(u.JSON.raw), &v)
	return
}

func (u ResponseCodeInterpreterToolCallResultsUnion) AsFiles() (v ResponseCodeInterpreterToolCallResultsFiles) {
	apijson.UnmarshalRoot(json.RawMessage(u.JSON.raw), &v)
	return
}

// Returns the unmodified JSON received from the API
func (u ResponseCodeInterpreterToolCallResultsUnion) RawJSON() string { return u.JSON.raw }

func (r *ResponseCodeInterpreterToolCallResultsUnion) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// The output of a code interpreter tool call that is text.
type ResponseCodeInterpreterToolCallResultsLogs struct {
...
// Returns the unmodified JSON received from the API
func (r ResponseCodeInterpreterToolCallResultsLogs) RawJSON() string { return r.JSON.raw }
func (r *ResponseCodeInterpreterToolCallResultsLogs) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// The output of a code interpreter tool call that is a file.
type ResponseCodeInterpreterToolCallResultsFiles struct {
	Files []ResponseCodeInterpreterToolCallResultsFilesFile `json:"files,required"`
...
// Returns the unmodified JSON received from the API
func (r ResponseCodeInterpreterToolCallResultsFiles) RawJSON() string { return r.JSON.raw }
func (r *ResponseCodeInterpreterToolCallResultsFiles) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type ResponseCodeInterpreterToolCallResultsFilesFile struct {
	// The ID of the file.
...
// Returns the unmodified JSON received from the API
func (r ResponseCodeInterpreterToolCallResultsFilesFile) RawJSON() string { return r.JSON.raw }
func (r *ResponseCodeInterpreterToolCallResultsFilesFile) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
// ResponseComputerToolCallActionDoubleClick, ResponseComputerToolCallActionDrag,
// ResponseComputerToolCallActionKeypress, ResponseComputerToolCallActionMove,
// ResponseComputerToolCallActionScreenshot, ResponseComputerToolCallActionScroll,
// ResponseComputerToolCallActionType, ResponseComputerToolCallActionWait].
//
// Use ResponseComputerToolCallActionUnion.AsAny() to switch on the variant.
//
// Use the methods beginning with 'As' to cast the union to one of its variants.
...
//
// Use ResponseContentPartAddedEventPartUnion.AsAny() to switch on the variant.
//
// Use the methods beginning with 'As' to cast the union to one of its variants.
...
// values from [ResponseOutputText, ResponseOutputRefusal].
//
// Use ResponseContentPartDoneEventPartUnion.AsAny() to switch on the variant.
//
// Use the methods beginning with 'As' to cast the union to one of its variants.
...
type ResponseFileSearchToolCallResult struct {
	...
	Attributes map[string]ResponseFileSearchToolCallResultsAttributesUnion `json:"attributes,nullable"`
...
// ResponseFileSearchToolCallResultsAttributesUnion contains all possible
...
type ResponseFileSearchToolCallResultsAttributesUnion struct {
...
func (u ResponseFileSearchToolCallResultsAttributesUnion) AsString() (v string) {
	apijson.UnmarshalRoot(json.RawMessage(u.JSON.raw), &v)
	return
}

func (u ResponseFileSearchToolCallResultsAttributesUnion) AsFloat() (v float64) {
	apijson.UnmarshalRoot(json.RawMessage(u.JSON.raw), &v)
	return
}

func (u ResponseFileSearchToolCallResultsAttributesUnion) AsBool() (v bool) {
	apijson.UnmarshalRoot(json.RawMessage(u.JSON.raw), &v)
	return
}

// Returns the unmodified JSON received from the API
func (u ResponseFileSearchToolCallResultsAttributesUnion) RawJSON() string { return u.JSON.raw }

func (r *ResponseFileSearchToolCallResultsAttributesUnion) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
//
// Use [param.IsOmitted] to confirm if a field is set.
type ResponseFileSearchToolCallResultsAttributesUnionParam struct {
	OfString param.Opt[string]
	OfFloat  param.Opt[float64]
	OfBool   param.Opt[bool]
	paramUnion
}
...
func (u *ResponseFileSearchToolCallResultsAttributesUnionParam) asAny() any {
	if !param.IsOmitted(u.OfString) {
		return &u.OfString.Value
...
//
// Use ResponseFormatTextConfigUnion.AsAny() to switch on the variant.
//
// Use the methods beginning with 'As' to cast the union to one of its variants.
...
// for more information.
//
// The properties ID, Arguments, CallID, Name, Type are required.
...
//
// Use ResponseInputContentUnion.AsAny() to switch on the variant.
//
// Use the methods beginning with 'As' to cast the union to one of its variants.
...
func ResponseInputItemParamOfComputerCallOutput(callID string, output ResponseInputItemComputerCallOutputOutputParam) ResponseInputItemUnionParam {
...
type ResponseInputItemUnionParam struct {
	...
	OfOutputMessage      *ResponseOutputMessageParam
	OfFileSearchCall     *ResponseFileSearchToolCallParam
	OfComputerCall       *ResponseComputerToolCallParam
...
func (u ResponseInputItemUnionParam) GetOutput() (res responseInputItemUnionParamOutput) {
	if vt := u.OfComputerCallOutput; vt != nil {
		res.ofResponseInputItemComputerCallOutputOutput = &vt.Output
	} else if vt := u.OfFunctionCallOutput; vt != nil {
...
type responseInputItemUnionParamOutput struct {
	ofResponseInputItemComputerCallOutputOutput *ResponseInputItemComputerCallOutputOutputParam
	ofString                                    *string
}
...
//
//	switch u.AsAny().(type) {
//	case *responses.ResponseInputItemComputerCallOutputOutputParam:
//	case *string:
//	default:
//	    fmt.Errorf("not present")
//	}
func (u responseInputItemUnionParamOutput) AsAny() any {
	if !param.IsOmitted(u.ofResponseInputItemComputerCallOutputOutput) {
		return u.ofResponseInputItemComputerCallOutputOutput
...
func (u responseInputItemUnionParamOutput) GetType() *string {
	if vt := u.ofResponseInputItemComputerCallOutputOutput; vt != nil {
		return (*string)(&vt.Type)
	}
	return nil
}
...
type ResponseInputItemComputerCallOutputParam struct {
	...
	Output ResponseInputItemComputerCallOutputOutputParam `json:"output,omitzero,required"`
...
//
// The property Type is required.
type ResponseInputItemComputerCallOutputOutputParam struct {
...
//
// Use ResponseOutputMessageContentUnion.AsAny() to switch on the variant.
//
// Use the methods beginning with 'As' to cast the union to one of its variants.
...
// Returns a pointer to the underlying variant's property, if present.
func (u ResponseOutputMessageContentUnionParam) GetAnnotations() []ResponseOutputTextAnnotationsUnionParam {
...
type ResponseOutputText struct {
	...
	Annotations []ResponseOutputTextAnnotationsUnion `json:"annotations,required"`
...
// ResponseOutputTextAnnotationsUnion contains all possible properties and values
// from [ResponseOutputTextAnnotationsFileCitation,
// ResponseOutputTextAnnotationsURLCitation,
// ResponseOutputTextAnnotationsFilePath].
//
// Use ResponseOutputTextAnnotationsUnion.AsAny() to switch on the variant.
//
// Use the methods beginning with 'As' to cast the union to one of its variants.
type ResponseOutputTextAnnotationsUnion struct {
	FileID string `json:"file_id"`
...
// Use the following switch statement to find the correct variant
//
//	switch variant := ResponseOutputTextAnnotationsUnion.AsAny().(type) {
//	case ResponseOutputTextAnnotationsFileCitation:
//	case ResponseOutputTextAnnotationsURLCitation:
//	case ResponseOutputTextAnnotationsFilePath:
//	default:
//	  fmt.Errorf("no variant present")
//	}
func (u ResponseOutputTextAnnotationsUnion) AsAny() any {
	switch u.Type {
	case "file_citation":
...
func (u ResponseOutputTextAnnotationsUnion) AsFileCitation() (v ResponseOutputTextAnnotationsFileCitation) {
	apijson.UnmarshalRoot(json.RawMessage(u.JSON.raw), &v)
	return
}

func (u ResponseOutputTextAnnotationsUnion) AsURLCitation() (v ResponseOutputTextAnnotationsURLCitation) {
	apijson.UnmarshalRoot(json.RawMessage(u.JSON.raw), &v)
	return
}

func (u ResponseOutputTextAnnotationsUnion) AsFilePath() (v ResponseOutputTextAnnotationsFilePath) {
	apijson.UnmarshalRoot(json.RawMessage(u.JSON.raw), &v)
	return
}

// Returns the unmodified JSON received from the API
func (u ResponseOutputTextAnnotationsUnion) RawJSON() string { return u.JSON.raw }

func (r *ResponseOutputTextAnnotationsUnion) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// A citation to a file.
type ResponseOutputTextAnnotationsFileCitation struct {
	// The ID of the file.
	FileID string `json:"file_id,required"`
...
// Returns the unmodified JSON received from the API
func (r ResponseOutputTextAnnotationsFileCitation) RawJSON() string { return r.JSON.raw }
func (r *ResponseOutputTextAnnotationsFileCitation) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// A citation for a web resource used to generate a model response.
type ResponseOutputTextAnnotationsURLCitation struct {
...
// Returns the unmodified JSON received from the API
func (r ResponseOutputTextAnnotationsURLCitation) RawJSON() string { return r.JSON.raw }
func (r *ResponseOutputTextAnnotationsURLCitation) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// A path to a file.
type ResponseOutputTextAnnotationsFilePath struct {
	// The ID of the file.
	FileID string `json:"file_id,required"`
	// The index of the file in the list of files.
	Index int64 `json:"index,required"`
...
// Returns the unmodified JSON received from the API
func (r ResponseOutputTextAnnotationsFilePath) RawJSON() string { return r.JSON.raw }
func (r *ResponseOutputTextAnnotationsFilePath) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
type ResponseOutputTextParam struct {
	// The annotations of the text output.
	Annotations []ResponseOutputTextAnnotationsUnionParam `json:"annotations,omitzero,required"`
	// The text output from the model.
	Text string `json:"text,required"`
	// The type of the output text. Always `output_text`.
	//
...
//
// Use [param.IsOmitted] to confirm if a field is set.
type ResponseOutputTextAnnotationsUnionParam struct {
	OfFileCitation *ResponseOutputTextAnnotationsFileCitationParam
	OfURLCitation  *ResponseOutputTextAnnotationsURLCitationParam
	OfFilePath     *ResponseOutputTextAnnotationsFilePathParam
	paramUnion
}
...
func (u *ResponseOutputTextAnnotationsUnionParam) asAny() any {
...
// Returns a pointer to the underlying variant's property, if present.
func (u ResponseOutputTextAnnotationsUnionParam) GetEndIndex() *int64 {
...
// Returns a pointer to the underlying variant's property, if present.
func (u ResponseOutputTextAnnotationsUnionParam) GetStartIndex() *int64 {
	if vt := u.OfURLCitation; vt != nil {
...
// Returns a pointer to the underlying variant's property, if present.
func (u ResponseOutputTextAnnotationsUnionParam) GetTitle() *string {
	if vt := u.OfURLCitation; vt != nil {
		return &vt.Title
	}
	return nil
...
// Returns a pointer to the underlying variant's property, if present.
func (u ResponseOutputTextAnnotationsUnionParam) GetURL() *string {
	if vt := u.OfURLCitation; vt != nil {
		return &vt.URL
	}
	return nil
...
// Returns a pointer to the underlying variant's property, if present.
func (u ResponseOutputTextAnnotationsUnionParam) GetFileID() *string {
...
// Returns a pointer to the underlying variant's property, if present.
func (u ResponseOutputTextAnnotationsUnionParam) GetIndex() *int64 {
	if vt := u.OfFileCitation; vt != nil {
...
// Returns a pointer to the underlying variant's property, if present.
func (u ResponseOutputTextAnnotationsUnionParam) GetType() *string {
	if vt := u.OfFileCitation; vt != nil {
		return (*string)(&vt.Type)
...
func init() {
	apijson.RegisterUnion[ResponseOutputTextAnnotationsUnionParam](
		"type",
		apijson.UnionVariant{
			TypeFilter:         gjson.JSON,
			Type:               reflect.TypeOf(ResponseOutputTextAnnotationsFileCitationParam{}),
			DiscriminatorValue: "file_citation",
		},
		apijson.UnionVariant{
			TypeFilter:         gjson.JSON,
			Type:               reflect.TypeOf(ResponseOutputTextAnnotationsURLCitationParam{}),
			DiscriminatorValue: "url_citation",
		},
		apijson.UnionVariant{
			TypeFilter:         gjson.JSON,
			Type:               reflect.TypeOf(ResponseOutputTextAnnotationsFilePathParam{}),
...
type ResponseOutputTextAnnotationsFileCitationParam struct {
	// The ID of the file.
	FileID string `json:"file_id,required"`
	// The index of the file in the list of files.
	Index int64 `json:"index,required"`
...
type ResponseOutputTextAnnotationsURLCitationParam struct {
	// The index of the last character of the URL citation in the message.
	EndIndex int64 `json:"end_index,required"`
	// The index of the first character of the URL citation in the message.
	StartIndex int64 `json:"start_index,required"`
...
//
// The properties FileID, Index, Type are required.
type ResponseOutputTextAnnotationsFilePathParam struct {
	// The ID of the file.
	FileID string `json:"file_id,required"`
	// The index of the file in the list of files.
	Index int64 `json:"index,required"`
...
// ResponseCreatedEvent, ResponseErrorEvent, ResponseFileSearchCallCompletedEvent,
// ResponseFileSearchCallInProgressEvent, ResponseFileSearchCallSearchingEvent,
// ResponseFunctionCallArgumentsDeltaEvent, ResponseFunctionCallArgumentsDoneEvent,
// ResponseInProgressEvent, ResponseFailedEvent, ResponseIncompleteEvent,
// ResponseOutputItemAddedEvent, ResponseOutputItemDoneEvent,
// ResponseRefusalDeltaEvent, ResponseRefusalDoneEvent,
// ResponseTextAnnotationDeltaEvent, ResponseTextDeltaEvent, ResponseTextDoneEvent,
// ResponseWebSearchCallCompletedEvent, ResponseWebSearchCallInProgressEvent,
// ResponseWebSearchCallSearchingEvent].
//
// Use ResponseStreamEventUnion.AsAny() to switch on the variant.
//
// Use the methods beginning with 'As' to cast the union to one of its variants.
...
//
// Use ResponseTextAnnotationDeltaEventAnnotationUnion.AsAny() to switch on the
// variant.
//
// Use the methods beginning with 'As' to cast the union to one of its variants.
...
//
// Use ToolUnion.AsAny() to switch on the variant.
//
// Use the methods beginning with 'As' to cast the union to one of its variants.
...
type ResponseNewParamsToolChoiceUnion struct {
	...
	OfHostedTool     *ToolChoiceTypesParam
