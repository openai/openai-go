...
type ChatCompletionChoice struct {
	...
	Logprobs ChatCompletionChoicesLogprobs `json:"logprobs,required"`
...
type ChatCompletionAssistantMessageParam struct {
	...
	Refusal param.Opt[string] `json:"refusal,omitzero,nullable"`
	// An optional name for the participant. Provides the model information to
	// differentiate between participants of the same role.
	Name param.Opt[string] `json:"name,omitzero"`
	// Data about a previous audio response from the model.
	// [Learn more](https://platform.openai.com/docs/guides/audio).
	Audio ChatCompletionAssistantMessageParamAudio `json:"audio,omitzero,nullable"`
	// The contents of the assistant message. Required unless `tool_calls` or
	// `function_call` is specified.
	Content ChatCompletionAssistantMessageParamContentUnion `json:"content,omitzero,nullable"`
	// Deprecated and replaced by `tool_calls`. The name and arguments of a function
	// that should be called, as generated by the model.
	//
	// Deprecated: deprecated
	FunctionCall ChatCompletionAssistantMessageParamFunctionCall `json:"function_call,omitzero,nullable"`
...
type ChatCompletionAssistantMessageParamContentUnion struct {
	...
	OfArrayOfContentParts []ChatCompletionAssistantMessageParamContentArrayOfContentPartsUnionItem
	paramUnion
}
...
//
// Use [param.IsOmitted] to confirm if a field is set.
type ChatCompletionAssistantMessageParamContentArrayOfContentPartsUnionItem struct {
...
func (u *ChatCompletionAssistantMessageParamContentArrayOfContentPartsUnionItem) asAny() any {
...
func (u ChatCompletionAssistantMessageParamContentArrayOfContentPartsUnionItem) GetText() *string {
...
// Returns a pointer to the underlying variant's property, if present.
func (u ChatCompletionAssistantMessageParamContentArrayOfContentPartsUnionItem) GetRefusal() *string {
...
// Returns a pointer to the underlying variant's property, if present.
func (u ChatCompletionAssistantMessageParamContentArrayOfContentPartsUnionItem) GetType() *string {
	if vt := u.OfText; vt != nil {
...
func init() {
	apijson.RegisterUnion[ChatCompletionAssistantMessageParamContentArrayOfContentPartsUnionItem](
		"type",
...
func ChatCompletionContentPartParamOfText(text string) ChatCompletionContentPartUnionParam {
	var variant ChatCompletionContentPartTextParam
	variant.Text = text
	return ChatCompletionContentPartUnionParam{OfText: &variant}
}

func ChatCompletionContentPartParamOfImageURL(imageURL ChatCompletionContentPartImageImageURLParam) ChatCompletionContentPartUnionParam {
	var variant ChatCompletionContentPartImageParam
	variant.ImageURL = imageURL
	return ChatCompletionContentPartUnionParam{OfImageURL: &variant}
}

func ChatCompletionContentPartParamOfInputAudio(inputAudio ChatCompletionContentPartInputAudioInputAudioParam) ChatCompletionContentPartUnionParam {
...
func ChatCompletionContentPartParamOfFile(file ChatCompletionContentPartFileFileParam) ChatCompletionContentPartUnionParam {
...
// Returns the unmodified JSON received from the API
func (r ChatCompletionMessageAnnotationsURLCitation) RawJSON() string { return r.JSON.raw }
func (r *ChatCompletionMessageAnnotationsURLCitation) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
func ChatCompletionMessageParamOfSystem[T string | []ChatCompletionContentPartTextParam](content T) ChatCompletionMessageParamUnion {
...
func ChatCompletionMessageParamOfUser[T string | []ChatCompletionContentPartUnionParam](content T) ChatCompletionMessageParamUnion {
...
func ChatCompletionMessageParamOfTool[T string | []ChatCompletionContentPartTextParam](content T, toolCallID string) ChatCompletionMessageParamUnion {
...
//	case *[]openai.ChatCompletionAssistantMessageParamContentArrayOfContentPartsUnionItem:
//	default:
...
type ChatCompletionNewParamsFunctionCallUnion struct {
	...
	OfFunctionCallMode   param.Opt[string]
...
type ChatCompletionNewParamsWebSearchOptions struct {
	...
	UserLocation ChatCompletionNewParamsWebSearchOptionsUserLocation `json:"user_location,omitzero,nullable"`
