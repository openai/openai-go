...
func TestAdminOrganizationProjectDataRetentionGet(t *testing.T) {
	...
	_, err := client.Admin.Organization.Projects.DataRetention.Get(context.TODO(), "project_id")
	if err != nil {
...
func TestAdminOrganizationProjectDataRetentionUpdate(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
