...
type EvalItem struct {
	...
	Content EvalItemContentUnion `json:"content,required"`
	// The role of the message input. One of `user`, `assistant`, `system`, or
	// `developer`.
	//
	// Any of "user", "assistant", "system", "developer".
	Role EvalItemRole `json:"role,required"`
	// The type of the message input. Always `message`.
	//
	// Any of "message".
	Type EvalItemType `json:"type"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
	JSON struct {
...
// Returns the unmodified JSON received from the API
func (r EvalItem) RawJSON() string { return r.JSON.raw }
func (r *EvalItem) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// ToParam converts this EvalItem to a EvalItemParam.
//
// Warning: the fields of the param type will not be present. ToParam should only
// be used at the last possible moment before sending a request. Test for this with
// EvalItemParam.Overrides()
func (r EvalItem) ToParam() EvalItemParam {
	return param.Override[EvalItemParam](r.RawJSON())
}

// EvalItemContentUnion contains all possible properties and values from [string],
// [responses.ResponseInputText], [EvalItemContentOutputText].
//
// Use the methods beginning with 'As' to cast the union to one of its variants.
//
// If the underlying value is not a json object, one of the following properties
// will be valid: OfString]
type EvalItemContentUnion struct {
	// This field will be present if the value is a [string] instead of an object.
	OfString string `json:",inline"`
...
func (u EvalItemContentUnion) AsString() (v string) {
	apijson.UnmarshalRoot(json.RawMessage(u.JSON.raw), &v)
	return
}

func (u EvalItemContentUnion) AsInputText() (v responses.ResponseInputText) {
	apijson.UnmarshalRoot(json.RawMessage(u.JSON.raw), &v)
	return
}

func (u EvalItemContentUnion) AsOutputText() (v EvalItemContentOutputText) {
	apijson.UnmarshalRoot(json.RawMessage(u.JSON.raw), &v)
	return
}

// Returns the unmodified JSON received from the API
func (u EvalItemContentUnion) RawJSON() string { return u.JSON.raw }

func (r *EvalItemContentUnion) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
// Returns the unmodified JSON received from the API
func (r EvalItemContentOutputText) RawJSON() string { return r.JSON.raw }
func (r *EvalItemContentOutputText) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
type EvalItemParam struct {
	// Text inputs to the model - can contain template strings.
	Content EvalItemContentUnionParam `json:"content,omitzero,required"`
	// The role of the message input. One of `user`, `assistant`, `system`, or
	// `developer`.
	//
	// Any of "user", "assistant", "system", "developer".
	Role EvalItemRole `json:"role,omitzero,required"`
	// The type of the message input. Always `message`.
	//
	// Any of "message".
	Type EvalItemType `json:"type,omitzero"`
	paramObj
}

func (r EvalItemParam) MarshalJSON() (data []byte, err error) {
	type shadow EvalItemParam
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *EvalItemParam) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
//
// Use [param.IsOmitted] to confirm if a field is set.
type EvalItemContentUnionParam struct {
	OfString     param.Opt[string]                 `json:",omitzero,inline"`
	OfInputText  *responses.ResponseInputTextParam `json:",omitzero,inline"`
	OfOutputText *EvalItemContentOutputTextParam   `json:",omitzero,inline"`
	paramUnion
}

func (u EvalItemContentUnionParam) MarshalJSON() ([]byte, error) {
	return param.MarshalUnion[EvalItemContentUnionParam](u.OfString, u.OfInputText, u.OfOutputText)
}
func (u *EvalItemContentUnionParam) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, u)
}

func (u *EvalItemContentUnionParam) asAny() any {
	if !param.IsOmitted(u.OfString) {
		return &u.OfString.Value
...
func (u EvalItemContentUnionParam) GetText() *string {
...
// Returns a pointer to the underlying variant's property, if present.
func (u EvalItemContentUnionParam) GetType() *string {
	if vt := u.OfInputText; vt != nil {
...
type EvalItemContentOutputTextParam struct {
	// The text output from the model.
	Text string `json:"text,required"`
	// The type of the output text. Always `output_text`.
	//
...
func (r EvalItemContentOutputTextParam) MarshalJSON() (data []byte, err error) {
	type shadow EvalItemContentOutputTextParam
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *EvalItemContentOutputTextParam) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
